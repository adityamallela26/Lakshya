...
export const WhatsAppTab: React.FC = () => {
  ...
  const generateWhatsAppMessage = () => {
    ...
    msg += `📅 *DateCoordinates:* June 6, 2026\n`;
  ...
  }, [goals, tasks, revisions, habits, templateHeader, signature, isStudent]);
  ...
  return (
    <div className="space-y-8 animate-fade-in" id="whatsapp-tab-root">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500">Draft beautiful progress reports automatically to share with study groups, guardians, or accountability buddies</p>
      </div>
